...
//==============================================================================
const String MultiEffectsAudioProcessor::getName() const
{
...
const String MultiEffectsAudioProcessor::getProgramName (int index)
{
    return {};
}

void MultiEffectsAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void MultiEffectsAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* MultiEffectsAudioProcessor::createEditor()
{
    return new MultiEffectsAudioProcessorEditor (*this);
}

//==============================================================================
void MultiEffectsAudioProcessor::getStateInformation (MemoryBlock& destData)
{
